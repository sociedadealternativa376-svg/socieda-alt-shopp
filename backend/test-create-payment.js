// Simple test script to POST a payment to local backend
// Create a card token via Mercado Pago public API, then call our backend with the token
(async () => {
  try {
    ...
    const payload = {
      items: [{ id: '1', title: 'Teste', quantity: 1, unit_price: 10.0 }],
